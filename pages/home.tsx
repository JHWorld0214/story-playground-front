  ...
  return (
    <div className="w-full h-[100vh] flex flex-col items-center justify-center pl-[280px]">
      ...
      <div className="w-5/6 flex flex-col items-center justify-center">
        {/*검색창*/}
        <div className="w-4/5 h-[60px] flex flex-row items-center gap-3 border-2 border-gray-200 rounded-3xl drop-shadow-sm">
          ...
          <div className="flex flex-row items-center justify-between pl-2 pr-2">
            <input type="text" placeholder="Search" className="text text-xl h-full w-[470px] outline-0 no-underline placeholder-gray-300">
            </input>
            <IconSearch
            alt="search icon"
            width={20}
